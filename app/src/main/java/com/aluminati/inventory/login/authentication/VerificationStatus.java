...
public class VerificationStatus {
    ...
    public static final int LINKING_ACTIVITY = 2001;
    public static final int LOGIN_ACTIVITY = 2002;
    public static final int SUCCESSFULL_UPDATE = 3001;
    public static final int FAILED_UPDATE = 3002;
